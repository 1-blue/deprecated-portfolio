...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const result = matter(markdownFile).data;

  const { title, email, phone, contents } = result;
  const updatedAt = JSON.parse(JSON.stringify(result.date));
